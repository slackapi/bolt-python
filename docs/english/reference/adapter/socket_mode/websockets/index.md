---
sidebar_label: slack_bolt.adapter.socket_mode.websockets
...
```python
async def handle(client: AsyncBaseSocketModeClient,
...
```python
async def send_async_response(client: AsyncBaseSocketModeClient,
                              req: SocketModeRequest, bolt_resp: BoltResponse,
                              start_time: float)
```
