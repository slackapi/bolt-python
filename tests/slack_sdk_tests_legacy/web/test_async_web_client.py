...
from .mock_web_api_server import setup_mock_web_api_server, cleanup_mock_web_api_server
...
class TestAsyncWebClient(unittest.TestCase):
    ...
    async def test_the_api_call_files_argument_creates_the_expected_data(self):
        ...
        resp = await self.client.users_setPhoto(image="tests/slack_sdk_tests_legacy/data/slack_logo.png")
        self.assertEqual(200, resp.status_code)
