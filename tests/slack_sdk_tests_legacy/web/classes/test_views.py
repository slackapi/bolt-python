...
class ViewTests(unittest.TestCase):
    ...
    def test_load_modal_view_001(self):
        with open("tests/slack_sdk_tests_legacy/data/view_modal_001.json") as file:
            self.verify_loaded_view_object(file)

    def test_load_modal_view_002(self):
        with open("tests/slack_sdk_tests_legacy/data/view_modal_002.json") as file:
            self.verify_loaded_view_object(file)

    def test_load_modal_view_003(self):
        with open("tests/slack_sdk_tests_legacy/data/view_modal_003.json") as file:
            self.verify_loaded_view_object(file)

    def test_load_modal_view_004(self):
        with open("tests/slack_sdk_tests_legacy/data/view_modal_004.json") as file:
            self.verify_loaded_view_object(file)

    def test_load_modal_view_005(self):
        with open("tests/slack_sdk_tests_legacy/data/view_modal_005.json") as file:
            self.verify_loaded_view_object(file)

    def test_load_modal_view_006(self):
        with open("tests/slack_sdk_tests_legacy/data/view_modal_006.json") as file:
            self.verify_loaded_view_object(file)

    def test_load_modal_view_007(self):
        with open("tests/slack_sdk_tests_legacy/data/view_modal_007.json") as file:
            self.verify_loaded_view_object(file)

    def test_load_modal_view_008(self):
        with open("tests/slack_sdk_tests_legacy/data/view_modal_008.json") as file:
            self.verify_loaded_view_object(file)

    def test_load_modal_view_009(self):
        with open("tests/slack_sdk_tests_legacy/data/view_modal_009.json") as file:
            self.verify_loaded_view_object(file)

    def test_load_modal_view_010(self):
        with open("tests/slack_sdk_tests_legacy/data/view_modal_010.json") as file:
            self.verify_loaded_view_object(file)
    ...
    def test_load_home_tab_view_001(self):
        with open("tests/slack_sdk_tests_legacy/data/view_home_001.json") as file:
            self.verify_loaded_view_object(file)

    def test_load_home_tab_view_002(self):
        with open("tests/slack_sdk_tests_legacy/data/view_home_002.json") as file:
            self.verify_loaded_view_object(file)

    def test_load_home_tab_view_003(self):
        with open("tests/slack_sdk_tests_legacy/data/view_home_003.json") as file:
            self.verify_loaded_view_object(file)

    def test_load_home_tab_view_004(self):
        with open("tests/slack_sdk_tests_legacy/data/view_home_004.json") as file:
            self.verify_loaded_view_object(file)

    def test_load_home_tab_view_005(self):
        with open("tests/slack_sdk_tests_legacy/data/view_home_005.json") as file:
            self.verify_loaded_view_object(file)

    def test_load_home_tab_view_006(self):
        with open("tests/slack_sdk_tests_legacy/data/view_home_006.json") as file:
            self.verify_loaded_view_object(file)
