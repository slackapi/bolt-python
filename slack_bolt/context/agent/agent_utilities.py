...
class AgentUtilities:
    """Experimental: Per-request agent utilities injected as the ``agent`` listener argument.

    Provides access to the tool registry and convenience methods for building
    AI-powered Slack agents.
    ...
    def chat_stream(
        ...
        **kwargs,
        ...
        Wraps ``WebClient.chat_stream()`` with sensible defaults from the
